...
const Footer = () => {
    return (
        <div className="overflow-x-hidden">
            <footer className="footer mb-10 mt-32 p-20 bg-slate-900 text-base-content rounded-lg w-[400px] md:w-[740px] lg:w-full mx-auto">
                <nav className="space-y-4 ">
                    ...
                    <div className="lg:flex justify-center items-center gap-3">
                        ...
                        <Link to='/' className="text-3xl ml-2 uppercase text-blue-500">DiagnoEasy</Link>
                    </div>


                    <div className="flex flex-col text-xl font-bold">
                        <a className="link link-hover">82, Segunbagicha, Dhaka 1000</a>
                        <a className="link link-hover mt-4">Email: diagno@easy.com</a>
                ...
                <nav className="space-y-3 text-2xl font-bold ">
                    ...
                    <NavLink to='/services'>Our Services</NavLink>                        <Link to="/dashboard/myProfile">
            ...
            <Link to="/" className="flex justify-center gap-3 text-white normal-case text-xl md:text-2xl mb-10">Copyright © 2023 - All right reserved by <span className="text-2xl md:text-3xl font-extrabold">DiagnoEasy</span></Link>
